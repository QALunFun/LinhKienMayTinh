...
if(isset($_POST['capnhatdonhang'])){
	...
	$sql_update_donhang = mysqli_query($mysqli,"UPDATE tbl_giohang SET tinhtrang='$xuly' WHERE mahang='$mahang'");
...
<?php
	...
	$sql_update_donhang = mysqli_query($mysqli,"UPDATE tbl_giohang SET huydon='$huydon' WHERE mahang='$magiaodich'");
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-5">
				...
				<?php
				$sql_select = mysqli_query($mysqli,"SELECT * FROM tbl_sanpham,tbl_khachhang,tbl_donhang WHERE tbl_donhang.sanpham_id=tbl_sanpham.sanpham_id AND tbl_donhang.khachhang_id=tbl_khachhang.khachhang_id GROUP BY mahang "); 
				?> 
				<table class="table table-bordered ">
					<tr>
						<th>Thứ tự</th>
